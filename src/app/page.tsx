...
export default function Home() {
  return (
    <main className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-2 text-center">NextwindBits</h1>
      <p className="text-lg text-gray-300 mb-8 text-center max-w-lg mx-auto">
        A curated collection of mini projects built with Next.js and styled with
        Tailwind CSS
      </p>
